            ...
            <main className="mx-auto max-w-7xl px-4 py-12">
                <div className="space-y-8">
                    ...
                    <div className="flex items-center gap-4 bg-green-50 border border-green-200 p-4 rounded-xl">
                        ...
                        <div>
                            <p className="text-green-800 font-bold text-sm">Verified</p>
                            <p className="text-green-700 text-xs">Your driver's license has been verified</p>
                        </div>
                    </div>

                    {/* Header Section */}
                    <div className="text-center space-y-2">
                        <h1 className="text-3xl font-bold uppercase text-gray-900">Update Your Driver's License</h1>
                        <p className="text-gray-500 font-medium">You can update your driver's license by uploading new images. At least one image is required</p>
                    </div>
                        ...
                        <CardHeader className="bg-white border-b border-gray-50 p-8">
                            ...
                            <Select defaultValue="drivers-license">
                                ...
                                <SelectContent className="rounded-xl border-gray-100 shadow-xl bg-white z-50" align="start" side="bottom" sideOffset={8}>
                                    <SelectItem value="drivers-license" className="py-3 font-bold uppercase text-xs tracking-tight hover:bg-gray-50">
                                        Driver's License
                                    </SelectItem>
                                    <SelectItem value="passport" className="py-3 font-bold uppercase text-xs tracking-tight hover:bg-gray-50">
                                        International Passport
                                    </SelectItem>
                                    <SelectItem value="national-id" className="py-3 font-bold uppercase text-xs tracking-tight hover:bg-gray-50">
                                        National ID Card
                                    </SelectItem>
                                </SelectContent>
                            </Select>
