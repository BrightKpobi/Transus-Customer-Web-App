...
import { AccraCars, LegonCars, CantonmentsCars, Car } from "@/data/CarsData";
import {
    DropdownMenu,
    DropdownMenuTrigger,
    DropdownMenuContent,
...
export default function FavouritesPage() {
    ...
    // Combine all cars from all locations
    const allCars: Car[] = [...AccraCars, ...LegonCars, ...CantonmentsCars];
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-950">
            ...
            <div className="mx-auto max-w-7xl px-4 py-6">
                <BackButton />
                <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">Favorites</h1>
                {favoriteCars.length === 0 ? (
                    <p className="text-gray-500 dark:text-gray-400 text-center">No favorites yet. Like a car to add it here!</p>
                ) : (
            ...
            <div className="flex-shrink-0">
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <button className="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800">
                            <MoreVertical size={18} />
                        </button>
                    </DropdownMenuTrigger>

                    <DropdownMenuContent align="end" className="w-44 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-lg dark:shadow-gray-900/50">
                        <DropdownMenuItem
                            className="text-yellow-600 dark:text-yellow-500 hover:bg-yellow-50 dark:hover:bg-yellow-900/20 font-semibold"
