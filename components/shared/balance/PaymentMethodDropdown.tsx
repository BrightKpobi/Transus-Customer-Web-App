    ...
    return (
        <section className="space-y-4 lg:space-y-6">
                ...
                <DropdownMenuTrigger asChild>
                    <div className="w-full p-4 lg:p-5 flex items-center justify-between border border-gray-200 rounded-2xl lg:rounded-[28px] cursor-pointer hover:border-gray-900 transition-all bg-white group">
                        <div className="flex items-center gap-3 lg:gap-5">
                            ...
                            <div>
                                <p className="font-bold uppercase text-[11px] lg:text-xs tracking-tight text-gray-900 mb-0.5 lg:mb-1">
                                    {selectedProvider.name}
                                </p>
                                <p className="text-[10px] lg:text-xs font-bold text-gray-400 tracking-[0.1em]">
                ...
                <DropdownMenuContent className="w-[--radix-dropdown-menu-trigger-width] p-2 bg-white border border-gray-100 rounded-2xl shadow-xl z-[60]">
                    {providers.map(provider => (
                        <DropdownMenuItem
                            ...
                            className="flex items-center justify-between p-3 rounded-xl cursor-pointer hover:bg-gray-50"
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-bold uppercase text-[10px] text-gray-900">
                                        {provider.name}
                                    </p>
            ...
            <div className="p-6 lg:p-8 bg-gray-50 rounded-[24px] lg:rounded-[32px] border border-gray-100">
                <h3 className="text-[10px] lg:text-xs font-black uppercase tracking-widest text-gray-900 mb-2">
                    Security Tip
                </h3>
